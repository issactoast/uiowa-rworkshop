...
* I wrote `R` package, `ikhyd`.

* Mainly for driving behavior analysis, but it has a **GPS visualization** function `track_vis()`.

* I will guide you how to make this function
